		...
		<main>
			...
			<div className="wrap">
				...
				<section>
					...
					<p className="note">
						Scope includes strategy, application authoring, budgeting,
						host‑letter orchestration, mapping optimization, utility
						coordination, client communications, packaging, and submission QA.
					</p>
					<div className="card">
				...
				<section>
					...
					<div className="card">
						...
						<p className="note">
							If Early Bird (−10%) or Rush (+20%) applies, milestone amounts
							scale by the same percentage.
						</p>
					</div>
				</section>
